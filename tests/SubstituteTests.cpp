...
TEST_CASE("OptionalSubstitueTest1", "[OptionalSubstitute]")
{
	...
	// For ease of visualization to you the human:
//					     "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	const std::string CORRECT_DECRYPTION = "--------------------------";
	REQUIRE( decryptSubstitution(MESSAGE, CRIB, substitutionMap ) );
	REQUIRE( substitutionMap  == CORRECT_DECRYPTION) ;
}

TEST_CASE("OptionalSubstituteTest2", "[OptionalSubstitute]")
{
	const std::string MESSAGE = "LORD OF THE RINGS";
	const std::string CRIB = "";
	std::string substitutionMap ;
	// For ease of visualization to you the human:
//					     "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
...
TEST_CASE("OptionalSubstituteTest3", "[OptionalSubstitute]")
{
	const std::string MESSAGE = "A33F 3IQ";
	const std::string CRIB = "GOOD ONE";
	std::string substitutionMap ;
	// For ease of visualization to you the human:
//					     "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
...
TEST_CASE("OptionalSubstituteTest4", "[OptionalSubstitute]")
{
	const std::string MESSAGE = "";
	const std::string CRIB = "GOOD ONE";
	std::string substitutionMap ;
...
TEST_CASE("OptionalSubstituteTest5", "[OptionalSubstitute]")
{
	const std::string MESSAGE = "HZAH ZEUEH";
	const std::string CRIB = "G";
	std::string substitutionMap ;
	// For ease of visualization to you the human:
//					     "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	const std::string CORRECT_DECRYPTION = "------H-------------------";
	REQUIRE( decryptSubstitution(MESSAGE, CRIB, substitutionMap ) );
	REQUIRE( substitutionMap  == CORRECT_DECRYPTION);
}
